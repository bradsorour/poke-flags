...
# image = cv2.imread('flag_south_africa.jpg')
# image = cv2.imread('surfing.jpg')
image = cv2.imread("bushfire.jpg")
...
def get_colors(image, number_of_colors, show_chart):
    ...
    # 255 again while finding the colors. If show_chart is True, we plot a pie chart with each pie chart portion defined using count.values(), labels as hex_colors and colors as ordered_colors. We finally return the rgb_colors which we’ll use at a later stage.
...
# get_colors(get_image('flag_south_africa.jpg'), 8, True)
# get_colors(get_image('surfing.jpg'), 8, True)
get_colors(get_image("bushfire.jpg"), 8, True)
